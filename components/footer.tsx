      ...
      <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8 relative z-10">
        <div className="grid gap-20 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5 space-y-10">
            <Link href="/" className="flex items-center gap-5 group">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-serif font-bold text-white leading-tight tracking-tight">
                  St. Mary&apos;s University
                </span>
                <span className="text-xs font-bold uppercase tracking-[0.4em] text-primary/60 leading-none mt-1">
                  Career Connect
                </span>
              </div>
            </Link>
            ...
            <div className="flex items-center gap-6">
              <div className="h-12 w-12 rounded-sm border border-white/10 flex items-center justify-center hover:bg-primary hover:text-background transition-all duration-500 cursor-pointer group">
          ...
          <div className="lg:col-span-7 grid gap-12 sm:grid-cols-3">
            <div>
              <h3 className="text-[10px] font-bold uppercase tracking-[0.4em] text-primary mb-10">
                Academic
              </h3>
            ...
            <div>
              ...
              <ul className="space-y-6">
                ...
                <li>
                  <Link href="https://www.smuc.edu.et/index.php/students/campus-life" target="_blank" className="text-xs font-bold uppercase tracking-widest text-white/40 hover:text-primary flex items-center group transition-colors">
                    <ArrowRight className="h-3 w-3 mr-2 opacity-0 -ml-4 group-hover:opacity-100 group-hover:ml-0 transition-all" />
                    Campus Life
                  </Link>
                </li>
                <li>
                  <Link href="https://www.smuc.edu.et/index.php/about-smu/alumni" target="_blank" className="text-xs font-bold uppercase tracking-widest text-white/40 hover:text-primary flex items-center group transition-colors">
                    <ArrowRight className="h-3 w-3 mr-2 opacity-0 -ml-4 group-hover:opacity-100 group-hover:ml-0 transition-all" />
                    Alumni Network
                  </Link>
                </li>
        ...
        <div className="mt-32 pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-12">
            <Link href="https://www.smuc.edu.et" target="_blank" className="text-[9px] font-bold uppercase tracking-[0.3em] text-white/10 hover:text-primary transition-colors">Privacy Policy</Link>
            <Link href="https://www.smuc.edu.et" target="_blank" className="text-[9px] font-bold uppercase tracking-[0.3em] text-white/10 hover:text-primary transition-colors">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
